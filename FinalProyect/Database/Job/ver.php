...
if( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    $sql = "SELECT * FROM trab_solicitud WHERE id=$id";
...
<body>
    <div class="container my-5">
        <h2>Solicitud de trabajo <?php echo $nombre ?></h2>
        ...
        <input type="hidden" name="id" value="<?php echo $id; ?>">
            <div class = "row mb-3">
                ...
                <div class="col-sm-6">
                    <textarea style = "height: 200px;" readonly class = "form-control"> <?php echo $motivo; ?> </textarea>
                </div>
            </div>
            <div class = "row mb-3">
                <label class = "col-sm-3 col-form-label">Posición solicitada: </label>
                <div class="col-sm-6">
                    <input class = "form-control" readonly value = "<?php echo $position; ?>">
                </div>
            </div>
            <div class = "row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class = "btn btn-outline-primary" href = "/FinalProyect/Database/dashboard.php" role = "button">Regresar</a>
                </div>
            </div>
    </div>
</body>
